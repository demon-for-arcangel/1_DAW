...
fun main(args: Array<String>) {
    ...
    while (continuar){
        ...
        if (operacion != null){
            /**
             * Tenemos varias opciones que son los case (suma, resta, multiplicacion, division)
             * según la que elija el usuario se irá por una opción u otra
             * Cada opción realiza una operacion distinta.
             *
             */
            when (operacion){
                "suma" -> {
